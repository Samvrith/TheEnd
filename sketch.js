...
function preload() {
  ...
  groundImage = loadImage("forest2copy1.jpg");
  groundImage.y = windowHeight - 100;
...
function setup() {
  ...
  ground = createSprite(200, windowHeight - 5, 700, 30);
  ground.addImage("forest2copy1.jpg", groundImage);
